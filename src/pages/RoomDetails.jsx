    ...
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      <div className='flex flex-col md:flex-row md:justify-between mt-10'>
        <div className='flex flex-col'>
          <h1 class='text-3xl md:text-4xl font-playfair'>Experience Luxury Like Never Before</h1>
      ...
      <form className='flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded xl mx-auto mt-16 max-w-6xl'>
        <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500'>
          ...
          <button type='submit' className='bg-[#2563EB] hover:bg-primary-dull active:scale-95 transition-all text-white rounded-md max-md:w-full max-md:mt-6 md:px-25 py-3 md:py-4 text-base cursor-pointer'>
            Check Availability
          </button>
      ...
      <div className='flex flex-col items-start gap-4'>
          <div className='flex gap-4'>
            ...
            <div>
              <p className='text-lg md:text-xl'>Hosted by {room.hotel.sponser}</p>
          ...
          <button className='px-6 py-2.5 mt-4 rounded text-white bg-[#2563EB] hover
          :bg-primary-dull transition-all cursor-pointer'>Contact Now</button>
      </div>
